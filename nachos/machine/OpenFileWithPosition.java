...
public abstract class OpenFileWithPosition extends OpenFile {
  /**
   * Allocate a new <tt>OpenFileWithPosition</tt> with the specified name on the specified file
   * system.
   *
  ...
  /**
   * Allocate a new unnamed <tt>OpenFileWithPosition</tt> that is not associated with any file
   * system.
   */
