...
public final class Config {
  /**
   * Load configuration information from the specified file. Must be called before the Nachos
  ...
  public static void load(String fileName) {
    ...
    try {
      ...
      while (true) {
        ...
        if (s.ttype != StreamTokenizer.TT_WORD) loadError(line);

        String key = s.sval;

        if (s.nextToken() != StreamTokenizer.TT_WORD || !s.sval.equals("=")) loadError(line);

        if (s.nextToken() != StreamTokenizer.TT_WORD && s.ttype != '"') loadError(line);
        ...
        if (config.get(key) != null) loadError(line);
   ...
   * @return the value of the specified key, or <tt>null</tt> if it is not present.
   */
  ...
  /**
   * Get the value of a key in <tt>nachos.conf</tt>, returning the specified default if the key does
   * not exist.
   *
   * @param key the key to look up.
   * @param defaultValue the value to return if the key does not exist.
   * @return the value of the specified key, or <tt>defaultValue</tt> if it is not present.
   */
  ...
  /**
   * Get the value of an integer key in <tt>nachos.conf</tt>, returning the specified default if the
   * key does not exist.
   *
   * @param key the key to look up.
   * @param defaultValue the value to return if the key does not exist.
   * @return the value of the specified key, or <tt>defaultValue</tt> if the key does not exist.
   */
  ...
  /**
   * Get the value of a double key in <tt>nachos.conf</tt>, returning the specified default if the
   * key does not exist.
   *
   * @param key the key to look up.
   * @param defaultValue the value to return if the key does not exist.
  ...
  /**
   * Get the value of a boolean key in <tt>nachos.conf</tt>, returning the specified default if the
   * key does not exist.
   *
   * @param key the key to look up.
   * @param defaultValue the value to return if the key does not exist.
