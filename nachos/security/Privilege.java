 ...
 *
 * <p>Some privileged operations are guarded by the Nachos security manager:
 *
 * <ol>
 *   <li>creating threads
 ...
 *
 * <p>Some privileged operations require a capability:
 *
 * <ol>
 ...
 * operations. If you have discovered a loophole somewhere, notify someone.
 */
public abstract class Privilege {
  /**
   * Allocate a new <tt>Privilege</tt> object. Note that this object in itself does not encapsulate
   * privileged access until the machine devices fill it in.
   */
  public Privilege() {}
  ...
  /**
   * Add an <tt>exit()</tt> notification handler. The handler will be invoked by exit().
   *
  ...
  public interface InterruptPrivilege {
     ...
     *
     * @param inKernelMode <tt>true</tt> if the current thread is running kernel code,
     *     <tt>false</tt> if the current thread is running MIPS user code.
     */
  ...
  public interface TCBPrivilege {
     ...
     * <tt>AutoGrader.runningThread()</tt> <i>must</i> call this method before returning.
     *
