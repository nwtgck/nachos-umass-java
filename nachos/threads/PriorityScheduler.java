...
public class PriorityScheduler extends Scheduler {
  ...
  protected class ThreadState {
     ...
     * access to the resource guarded by <tt>waitQueue</tt>. This method is only called if the
     ...
     * <tt>waitQueue</tt>. This can occur either as a result of <tt>acquire(thread)</tt> being
     * invoked on <tt>waitQueue</tt> (where <tt>thread</tt> is the associated thread), or as a
     * result of <tt>nextThread()</tt> being invoked on <tt>waitQueue</tt>.
     *
