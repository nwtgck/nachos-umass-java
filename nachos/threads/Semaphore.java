 ...
 * </ul>
 *
 * <p>Note that this API does not allow a thread to read the value of the semaphore directly. Even
 * if you did read the value, the only thing you would know is what the value used to be. You don't
